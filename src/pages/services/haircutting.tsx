...
export function Haircutting() {
    return (
        <div className='haircutting-section w-100 mx-5 w-100 mt-5'>
            <h2>Haircutting</h2>
            <div className='d-flex justify-content-around w-100'>
                <DivImage height='30rem' width='30rem' img='/images/frank.png' smallClass='haircutting' />
                    ...
                    <div className='d-flex flex-column justify-content-center text-center mt-3'>
                        <div className='d-flex flex-column justify-content-center'>
                            ...
                            <small>
                                ...
                                consultation about your hair goals, a curly cut, hair detox, personalized treatment, in-depth styling
                                education, and a styling routine sheet to take home
                            </small>
                        </div>
                    </div>
                    <div className='d-flex flex-column justify-content-center text-center mt-3'>
                    ...
                    <div className='d-flex flex-column justify-content-center text-center mt-3'>
                        <div className='d-flex flex-column justify-content-center'>
                            ...
                            <small>
                                ...
                                <b>This service does not include a curly cut.</b> This service includes an in-depth consultation on your
                                hair goals, ahair detox treatment, a treatment personalized for your hair, product recommendations, curly
                                education, and a care sheet to take home
                            </small>
                        </div>
                    </div>
                    <div className='d-flex flex-column justify-content-center text-center mt-3'>
                        <div className='d-flex flex-column justify-content-center'>
                            ...
                            <small>
                                This service is for <b>returning guests only</b> who need their hair styled for an event or simply do not
                                want to wash their hair at home. This service includes a consultation and a curly style
                            </small>
                        </div>
                    </div>
                </div>
