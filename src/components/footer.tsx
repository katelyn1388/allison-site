        ...
        <div>
            {mobileView ? (
                <div className='footer'>
                    <div className='d-flex justify-content-around mt-0 row mx-3 text-center'>
                        ...
                        <div className='col-6 col-md-7 mt-4'>
                            <p>Hours: </p>
                    ...
                    <div className='d-flex justify-content-around  row'>
                        <div className='d-flex mt-4 flex-column col-12 col-md-4  mx-5'>
                            <p>
                                <a
                                    target='_blank'
                                    rel='noreferrer'
                        ...
                        <div className='d-flex mt-4 flex-column col-12 col-md-4 align-items-start'>
                            <p>
